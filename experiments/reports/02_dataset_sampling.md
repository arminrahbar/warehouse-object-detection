...
**Table 3: Candidate sampling strategy comparison.** The table compares the three candidate 5,000-image sampling strategies using class-distribution error, density-distribution error, rare-class retention, and dense-image coverage.
...
**Table 4: Full dataset vs selected sample summary.** The table compares overall object-density statistics for the full dataset and the selected 5,000-image subset.
...
### Figure 3: Full Dataset vs Selected Sample Class Distribution

![Figure 3: Full dataset vs selected sample class distribution](../figures/02_dataset_sampling/02_class_distribution_comparison.png)

**Figure 3: Full dataset vs selected sample class distribution.** This figure compares the object-share percentage of each class in the full dataset and in the selected 5,000-image sample.
...
**Table 5: Rare-class coverage in the selected sample.** The table shows the eight rarest classes by object count, their full-dataset image counts, their selected-sample image counts, and the target image counts enforced by the rare-aware sampling strategy.
...
### Figure 4: Full Dataset vs Selected Sample Object-Density Distribution

![Figure 4: Full dataset vs selected sample object-density distribution](../figures/02_dataset_sampling/03_density_distribution.png)

**Figure 4: Full dataset vs selected sample object-density distribution.** This figure compares the share of images in each object-count bucket for the full dataset and selected sample.
...
### Figure 5: Full Dataset vs Selected Sample Crowding Distribution

![Figure 5: Full dataset vs selected sample crowding distribution](../figures/02_dataset_sampling/04_crowding_distribution.png)

**Figure 5: Full dataset vs selected sample crowding distribution.** This figure compares the full dataset and selected sample using ground-truth box-pair overlap buckets. The buckets are based on how many ground-truth box pairs in an image have IoU greater than 0.1.
...
### Table 6: Overlap and Crowding Summary
...
**Table 6: Overlap and crowding summary.** The table compares full-dataset and selected-sample overlap statistics using pairwise ground-truth bounding-box IoU.
