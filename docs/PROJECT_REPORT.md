...
| Checkpoint comparison | `experiments/scripts/01_model_selection/01_compare_model_quality.py` |
| Dataset workload | `experiments/scripts/02_dataset_analysis/03_select_analysis_workload.py` |
| NMS sweep | `experiments/scripts/03_nms_thresholding/01_sweep_nms_thresholds.py` |
| Input-shift diagnostics | `experiments/scripts/04_augmentation_robustness/02_measure_augmentation_robustness.py` |
| Error-review queues | `experiments/scripts/05_hard_negative_mining/01_build_error_components.py` → `experiments/scripts/05_hard_negative_mining/02_build_error_review_queues.py` |
